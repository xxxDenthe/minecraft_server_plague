...
lmpc_classes-0.13.0.jar   четыре класса, требует curios
```
...
`lmpc_classes` 0.13.0 — все четыре класса играбельны: Клирик, Кузнец,
...
а не только за удачную. Заметки `2026-09-06-ochistitel-oblast-i-skorost.md`
