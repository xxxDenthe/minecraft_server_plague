...
lmpc_classes-0.12.0.jar   четыре класса, требует curios
```
...
`lmpc_classes` 0.12.0 — все четыре класса играбельны: Клирик, Кузнец,
...
Под землю добавлена курильница — ручная очистка без Create. Заметки
`2026-09-06-ochistitel-oblast-i-skorost.md` и `2026-09-06-kurilnica-i-forsazh.md`.
