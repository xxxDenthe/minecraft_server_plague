...
public class PurifierRenderer implements BlockEntityRenderer<PurifierBlockEntity> {
    ...
    /**
     * Длина огрызка от полного вала. Полный вал занимает блок целиком
     * и торчал бы наружу с обоих концов; нам нужен только выступ снизу.
     * (Вал Create — 4 x 4 пикселя, ровно как сопло: кольца вокруг сопла
     * не было бы. Прежний комментарий утверждал 6 — это неверно,
     * исправлено 2026-09-07.)
     */
    private static final float ДЛИНА = 0.30f;

    /**
     * Поджатие по горизонтали. Под очистителем обычно стоит настоящий вал
     * той же толщины 4 x 4; без поджатия их боковые грани совпали бы
