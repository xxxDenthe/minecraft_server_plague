...
const ICONS = {
  ...
  userPlus: '<path d="M13.5 20c0-3.3-2.9-6-6.5-6s-6.5 2.7-6.5 6"/><circle cx="7" cy="7.5" r="4"/><path d="M18 8.5v6M15 11.5h6"/>',
  video: '<rect x="3" y="5" width="18" height="14" rx="2.5"/><path d="M10.5 9.2v5.6l4.4-2.8z" fill="currentColor" stroke="none"/>',
